...
_EMATmag1 = "rhs_fgm148_magazine_AT";
_EMAT2 = "BWA3_Pzf3";
_EMATmag2 = "BWA3_Pzf3_IT";
_EMATmag3 = "rhs_fgm148_magazine_AT";*/
...
_baseHelmet = ["rhsusf_ach_bare_headset"]; //rhsusf_ach_helmet_ESS_ucp
...
// LOADOUT: GRENADIER
	...
	case "v_car":
	{
		...
		//_unit addMagazineCargoGlobal [_Eriflemag2, 8];
		//_unit addMagazineCargoGlobal [_Eriflemag3, 8];
		//_unit addMagazineCargoGlobal [_EARmag1, 6];
		//_unit addMagazineCargoGlobal [_EARmag2, 3];
		//_unit addMagazineCargoGlobal [_EARmag3, 6];
		//_unit addMagazineCargoGlobal [_Esmgmag1, 4];
		//_unit addMagazineCargoGlobal [_EMATmag1, 2];
		//_unit addWeaponCargoGlobal [_EMAT2, 2];
		//_unit addMagazineCargoGlobal [_EMATmag2, 2];
		//_unit addMagazineCargoGlobal [_EMATmag3, 2];
...
// CARGO: TRUCK - room for 50 weapons and 200 cargo items
	case "v_tr":
	{
		...
		//_unit addMagazineCargoGlobal [_Eriflemag1, 30];
		//_unit addMagazineCargoGlobal [_Eriflemag2, 30];
		//_unit addMagazineCargoGlobal [_Eriflemag3, 30];
		//_unit addMagazineCargoGlobal [_EARmag1, 20];
		//_unit addMagazineCargoGlobal [_EARmag2, 10];
		//_unit addMagazineCargoGlobal [_EARmag3, 20];
		//_unit addMagazineCargoGlobal [_Esmgmag1, 20];
		//_unit addMagazineCargoGlobal [_EMATmag1, 5];
		//_unit addWeaponCargoGlobal [_EMAT2, 5];
		//_unit addMagazineCargoGlobal [_EMATmag2, 5];
		//_unit addMagazineCargoGlobal [_EMATmag3, 5];
...
// CARGO: IFV - room for 10 weapons and 100 cargo items
	case "v_ifv":
	{
		...
		//_unit addMagazineCargoGlobal [_Eriflemag2, 20];
		//_unit addMagazineCargoGlobal [_Eriflemag3, 20];
		//_unit addMagazineCargoGlobal [_EARmag1, 8];
		//_unit addMagazineCargoGlobal [_EARmag2, 4];
		//_unit addMagazineCargoGlobal [_EARmag3, 8];
		//_unit addMagazineCargoGlobal [_Esmgmag1, 10];
		//_unit addMagazineCargoGlobal [_EMATmag1, 2];
		//_unit addWeaponCargoGlobal [_EMAT2, 2];
		//_unit addMagazineCargoGlobal [_EMATmag2, 2];
		//_unit addMagazineCargoGlobal [_EMATmag3, 2];
...
// CARGO: IFV - room for 10 weapons and 100 cargo items
	case "v_atv":
	{
		...
		//_unit addMagazineCargoGlobal [_Eriflemag2, 1];
		//_unit addMagazineCargoGlobal [_Eriflemag3, 1];
