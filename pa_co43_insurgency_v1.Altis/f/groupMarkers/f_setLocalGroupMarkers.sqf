...
// Markers seen by players in NATO slots.
	...
	case "blu_f":
	{
		...
		["GrpNATO_DC", 0, "DC", "ColorOrange"] spawn f_fnc_localGroupMarker;
		...
		["VehNATO_IFV1", 2, "IFV1", "ColorOrange"] spawn f_fnc_localSpecialistMarker;		
		["VehNATO_IFV2", 2, "IFV2", "ColorOrange"] spawn f_fnc_localSpecialistMarker;	
