...
private ["_geararray","_grpId","_customInit","_cPos","_skls","_skills","_dir","_range","_unitType","_unit","_radius","_still","_centerPos","_menAmount","_milGroup","_menArray","_redMenArray","_pos","_allUnitsArray","_menRatio","_validPos","_whichOne","_thisArray","_smokesAndChems"];
...
//_MenArray = ["O_Soldier_A_F","O_soldier_AR_F","O_medic_F","O_engineer_F","O_soldier_exp_F","O_Soldier_GL_F","O_soldier_M_F","O_soldier_AA_F","O_soldier_AT_F","O_officer_F","O_soldier_repair_F","O_Soldier_F","O_soldier_LAT_F","O_Soldier_lite_F","O_Soldier_SL_F","O_Soldier_TL_F","O_soldier_AAR_F","O_soldier_AAA_F","O_soldier_AAT_F"];
...

{
	if (_x == leader (group _x)) then{
		...
		//} else {
		[_x, _x, _radius, 7, "MOVE", "SAFE", "WHITE", "NORMAL", _formation, "group _x spawn CBA_fnc_searchNearby", [45,60,75]] call CBA_fnc_taskPatrol; //STAG COLUMN
		//};	
